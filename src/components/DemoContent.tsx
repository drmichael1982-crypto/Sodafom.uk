    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-8 px-4" style={{ background: `linear-gradient(to bottom right, hsl(var(--primary)), hsl(var(--secondary)))` }}>
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <button 
            className="px-8 py-3 bg-white font-bold rounded-lg shadow-lg hover:shadow-xl transition-all hover:scale-105"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold mb-2 text-gray-900">Fast Performance</h3>
            ...
            <div className="bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold mb-2 text-gray-900">Secure & Reliable</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold mb-2 text-gray-900">Customizable</h3>
              <p className="text-sm text-gray-600">
      ...
      <section className="py-6 px-4 bg-white">
        <div className="max-w-2xl mx-auto">
          ...
          <form className="space-y-3">
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 text-sm text-white font-bold rounded-lg shadow-md hover:shadow-lg transition-all hover:scale-[1.02]"
              style={{ backgroundColor: `hsl(var(--primary))` }}
            >
              Send Message
            </button>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="px-8 py-3 bg-white font-bold rounded-lg shadow-lg hover:shadow-xl transition-all hover:scale-105"
