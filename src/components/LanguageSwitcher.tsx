...
export default function LanguageSwitcher({
  ...
  const handleLanguageChange = (languageCode: string) => {
    ...
    // Build pattern from supported codes — escape each code to prevent regex injection
    const escapedCodes = supportedLanguages.map(l => l.code.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'));
    const langPattern = escapedCodes.join('|');
