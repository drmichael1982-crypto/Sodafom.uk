...
describe("llmsTxtHandler", () => {
	...
	it("serves a well-formed file with the right headers on a customer host", () => {
		...
		// The Sodafom export is deliberately seeded with its real brand name,
		// while generated links still use the current customer hostname.
		...
		expect(calls.body).toContain("# Sodafom");
