/**
 * /games/spelling — Spelling games hub (orange/secondary theme)
 * Shows ONLY spelling-subject games.
 */
  ...
  return (
    <main className="min-h-screen bg-background pb-20">
      <Helmet>
        ...
        <link rel="canonical" href="https://sodafom.uk/games/spelling" />
        <meta property="og:title" content="Spelling Hub — Sodafom" />
        <meta property="og:description" content="Your spelling learning hub on Sodafom. Browse all spelling and vocabulary games for ages 5–13." />
        <meta property="og:url" content="https://sodafom.uk/games/spelling" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://sodafom.uk/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Spelling Hub — Sodafom" />
        <meta name="twitter:description" content="Your spelling learning hub on Sodafom. Browse all spelling and vocabulary games for ages 5–13." />
        <meta name="twitter:image" content="https://sodafom.uk/og-image.png" />
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"WebPage","@id":"https://sodafom.uk/games/spelling#webpage","name":"Spelling Hub — Sodafom","url":"https://sodafom.uk/games/spelling","description":"Your spelling learning hub on Sodafom. Browse all spelling and vocabulary games for ages 5–13.","isPartOf":{"@id":"https://sodafom.uk/#website"},"about":{"@id":"https://sodafom.uk/#organization"}})}</script>
      </Helmet>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        {!subscribed && (
          <motion.div
            ...
            className="mt-10 rounded-3xl bg-secondary/5 border-2 border-secondary/20 p-6 text-center"
          >
            <p className="text-2xl mb-2">🔓</p>
            <h3 className="font-black text-foreground text-lg mb-1" style={{ fontFamily: 'var(--font-heading)' }}>
              Unlock all spelling games
            </h3>
            ...
            <Link
              to="/subscribe"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-secondary text-secondary-foreground font-black text-sm hover:opacity-90 transition-opacity"
            >
              Start free trial ✨
            </Link>
          </motion.div>
